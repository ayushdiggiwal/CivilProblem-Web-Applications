...
<script type="text/javascript" charset="utf8" src="http://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.8.2.min.js"></script>
  ...
  $(document).ready(function() {
    ...
    <body>
        ...
        <div class="container">
				    <div class=row>
				        <div class="col-sm-12">
  <h2 class = text-center style = "font-family : 'Monotype Corsiva' ; color : #E6120E">View New User Requests</h2>
  ...
  <% ResultSet rs = pDAO.newUserRequest(); 
%>
...
<td><a style = "font-size : 10pt" href="assignstatus.jsp?id=<%= rs.getString(1) %>">Assign Status</a></td>
