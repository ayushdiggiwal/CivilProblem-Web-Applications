...
<script type="text/javascript" charset="utf8" src="http://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.8.2.min.js"></script>
  ...
  <% ResultSet rs = pDAO.notstartedAdmin();
%>
...
if(pDAO.voteornot(aadharid,rs.getString(1))==1)
{
%>
...
{
%>
<td><a style = "font-size : 10pt" href="mycontroller.jsp?page=vote&userid=<%= pDAO.getUserID(session.getAttribute("username").toString())%>&pid=<%= rs.getString(1) %>">Vote Now</a></td>
<%
}																					
%>
